...

{
  ...
  PSYCHAD_METADATA_GITHUB_MINERVA = "/sc/arion/projects/roussp01a/jaro/github/psychad_metadata/"   # Minerva clone of github code for creating (this file) & querying clinical metadata
